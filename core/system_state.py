...
def initialize_system_state():
    """Αρχικοποίηση των 5 Πυλώνων του Συστήματος + UI State στο Session State"""

    # ── UI State (πρέπει να αρχικοποιούνται ΕΔΩ ώστε να είναι διαθέσιμα παντού) ──
    if 'mode' not in st.session_state:         st.session_state.mode = "home"
    if 'flow_step' not in st.session_state:    st.session_state.flow_step = 1
