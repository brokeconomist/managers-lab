...
def run_step(): # Αλλαγή ονόματος για να το βλέπει το app.py
    ...
    with res2:
        ...
        # Αυτόματο Save στο session state χωρίς έξτρα κουμπί για ευκολία
    ...
    # 5. NAVIGATION (Critical for the App Flow)
    nav_col1, nav_col2 = st.columns(2)
    
    with nav_col1:
        if st.button("⬅️ Back to Survival Anchor (Stage 1)", use_container_width=True):
